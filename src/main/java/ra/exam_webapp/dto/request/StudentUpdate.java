...
/**
 * DTO (Data Transfer Object) dành cho việc cập nhật thông tin sinh viên (Student).
 * Lớp này được sử dụng để nhận dữ liệu từ người dùng khi chỉnh sửa một sinh viên đã có trong hệ thống.
 */
@Getter
@Setter
@AllArgsConstructor
